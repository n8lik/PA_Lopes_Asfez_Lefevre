...
$ammount_room = $house['ammount_room'];
...
<div class="container border-form mt-5">
    ...
    <form method="POST" action="action?type=update&id=<?= $id ?>">
        <div>
            ...
            <label for="ammount_room">Nombre de chambre</label>
            <input type="number" name="ammount_room" id="ammount_room" class="form-control" value="<?php echo $ammount_room; ?>" style="width: 80% !important; " required>
